  ...
  const clientEmailHtml = `
    <div style="font-family:sans-serif;max-width:600px;margin:0 auto">
      ...
      <div style="background:#fafaf9;border:1px solid #e8e2dc;border-top:none;padding:24px;border-radius:0 0 8px 8px">
        ...
        <p style="color:#44403c;font-size:13px;line-height:1.6">Questions? Reply to this email or call <a href="tel:+16093660857" style="color:#c2410c">(609) 366-0857</a>.</p>
        <p style="color:#78716c;font-size:13px;margin-top:24px">— The Bliss Dermacare Team</p>
      </div>
    </div>`;

  const clientSmsText = `Hi ${customerName.split(' ')[0]}! 💗 Your appointment request for ${serviceNames.join(', ')} on ${dateLabel} at ${appointmentTime} has been received. We'll confirm within 24 hours. Questions? (609) 366-0857 — Bliss Dermacare`;
